...
<body class="bg-bglight dark:bg-bgdark font-poppins transition-colors duration-300">
  ...
  <footer class="pt-64">
    <div class="w-full flex flex-col justify-center items-center bg-[linear-gradient(to_bottom_right,_#EE9D06,_#FFB52C,_#FFB630)] py-12 md:py-20 px-6 md:px-20 lg:px-36">
